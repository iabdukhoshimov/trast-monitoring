    ...
    rules:
      ...
      - alert: ProbeSslCertExpiringSoon
        ...
        annotations:
          ...
          description: "{{ humanizeDuration $value }} ichida SSL sertifikat muddati tugaydi."
      ...
      - alert: ProbeSslCertExpiryImminent
        ...
        annotations:
          ...
          description: "{{ humanizeDuration $value }} ichida SSL sertifikat muddati tugaydi — zudlik bilan yangilang."
